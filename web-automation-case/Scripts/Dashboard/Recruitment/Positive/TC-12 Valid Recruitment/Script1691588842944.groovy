...
WebUI.setText(findTestObject('PageDashboard_OrangeHRM/PageRekrut_OrangeHRM/input_Full Name_firstName'), 'Ilyisium')
...
WebUI.setText(findTestObject('PageDashboard_OrangeHRM/PageRekrut_OrangeHRM/input_Full Name_lastName'), 'Electra')

'User mengisikan input email'
WebUI.setText(findTestObject('PageDashboard_OrangeHRM/PageRekrut_OrangeHRM/input_Email_oxd-input oxd-input--focus'), 'Electra@gmail.com')
